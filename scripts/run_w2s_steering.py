...
def main():
    ...
    # Przygotowanie katalogu wyjściowego i czyszczenie starego pliku przed nowym uruchomieniem
    os.makedirs(os.path.dirname(output_path), exist_ok=True)
    if os.path.exists(output_path):
        print(f"-> Removing old output file to start clean: {output_path}")
    ...
    for idx, row in prompts_df.iterrows():
        ...
        # --- ZAPIS NA BIEŻĄCO DO CSV (ZAPOBIEGA STRACIE DANYCH) ---
        # Jeśli plik jeszcze nie istnieje, zapisze go z nagłówkami. 
        # Jeśli istnieje, dopisze sam wiersz na koniec pliku (mode='a')
